...
class FormularioCadastro extends TPage
{
    ...
    public function __construct()
    {
        ...
        */
        ...
        $this->form->setFields( [ $codigo, $nome, $rg_cnh, $cpf, $contato, $email, $logradouro, $numero, $completo, $bairro, $botaoSalvar, $botaoEditar, $botaoLimpar ] );
        ...
        $panel = new TPanelGroup('Cadastro'); //Título da página
        $panel->add($this->form);
        $panel->addFooter($botoes); //Adicionando o objeto botões no rodapé da página
    ...
    */ 
    ...
    public function onSave($param)
    {
        ...
        try{
            ...
            $this->form->setData( $cliente ); //Deixando os campos preenchidos
